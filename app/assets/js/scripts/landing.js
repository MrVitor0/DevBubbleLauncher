...
function updateSelectedAccount(authUser) {
  ...
  avatarContainer.style.backgroundImage = "url('assets/images/SealCircle.png')";

  if (authUser != null) {
    if (authUser.displayName != null) {
      username = authUser.displayName;
    }
    if (authUser.uuid != null && !ConfigManager.isOfflineAccount(authUser)) {
...
async function asyncSystemScan(effectiveJavaOptions, launchAfter = true) {
  ...
  if (jvmDetails == null) {
    ...
    setOverlayContent(
      ...
      Lang.queryJS("landing.systemScan.installJavaMessage", {
    ...
    setDismissHandler(() => {
      $("#overlayContent").fadeOut(250, () => {
        ...
        setOverlayContent(
          ...
          Lang.queryJS("landing.systemScan.javaRequiredMessage", {
            major: effectiveJavaOptions.suggestedMajor,
          }),
