...
function setOverlayContent(
  ...
  description,
  acknowledge,
  dismiss = Lang.queryJS("overlay.dismiss"),
) {
...
document
  .getElementById("serverSelectConfirm")
...
function populateAccountListings() {
  ...
  for (let i = 0; i < accounts.length; i++) {
    const avatarSource = ConfigManager.isOfflineAccount(accounts[i])
      ? "assets/images/SealCircle.png"
      : `https://mc-heads.net/head/${accounts[i].uuid}/40`;
